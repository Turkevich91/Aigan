...
9. Use exactly one allowed reason code per candidate. Use `valid_until="none"` except when `candidate_type="validity_expiry"`, which requires the explicit future timestamp.
